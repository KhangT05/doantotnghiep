...
public class api_newDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        api_newGlobalFeatureConfigurator.Configure();
        api_newModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<api_newDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<api_newResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/api_new");

            options.DefaultResourceType = typeof(api_newResource);
        ...
        {
            options.MapCodeNamespace("api_new", typeof(api_newResource));
        });
    }
}
